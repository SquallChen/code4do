...
var data = [ {
	...
	"$tag" : 12,
	"label2" : "页面效果：从左至右滑出（旧页淡出效果）"
}, {
	"$tag" : 13,
	"label2" : "页面效果：从右至左滑出（旧页淡出效果）"
}, {
	"$tag" : 14,
	"label2" : "页面效果：从左至右推出（旧页被遮盖）"
}, {
	"$tag" : 15,
	"label2" : "页面效果：从右至左推出（旧页被遮盖）"
}, ]
