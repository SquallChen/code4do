...
var condata={type:2,title:"推荐商品",rimg:btnImg,hback:handback}
...
okbtn.on("touch",function(){
	anim.animbtn(okbtn);
	page.hideKeyboard();
	request_http.url = $U.token($U.url.merchantRecommendEdit,"token")+"&content="+Euc(tuijian.text);
	request_http.request();
});


var tuijian = ui("do_TextBox_1");
tuijian.text = str;
