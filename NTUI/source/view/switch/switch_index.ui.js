 ...
 * switch
 */
var switchtxt = rootview.add("txtswitch","source://view/switch/switch_text.ui",100,260);
var switchtxtS = ui("txtswitch");
var swtxt = [1,"0","1"]; //0:开关状态  1:关闭状态文字 2:开启状态文字

switchtxtS.on("switchtag",function(data){
	var lb1 = ui("do_Button_1");
	lb1.text = "状态: "+data;
});
 ...
 * switchAndroid
 */
var switchAtxt = rootview.add("txtswitchA","source://view/switch/switch_android.ui",350,260);
var switchAtxtS = ui("txtswitchA");
var swtxtA = [0,"0","1"]; //0:开关状态  1:关闭状态文字 2:开启状态文字

switchAtxtS.on("switchAtag",function(data){
	var lb1 = ui("do_Button_1");
	lb1.text = "状态: "+data;
});
switchAtxtS.fire("switchAzt",swtxtA);
