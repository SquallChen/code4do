 ...
 * 底部文本输入
 */
var popinput = rootview.add("inputpop", "source://view/dialog/dialog_input.ui", 0, 0);
var popinputf = ui("inputpop");
var popinputbtn = ui("do_Button_1");
var piother = {istext:1,psw:false,hint:"提示内容呗!!",text:"哈哈哈哈",title:"输入弹出标题"}
