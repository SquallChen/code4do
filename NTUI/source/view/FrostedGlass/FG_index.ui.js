...
var bmap = mm("do_Bitmap");
//var glasslay = ui("do_ImageView_1");

//device.srceenShotAsBitmap({bitmap:bmap,rect:""},function(data){
//	bmap.toFrostedGlass({degree:2}, function(data) {
//		deviceone.print(data);
//		glasslay.setBitmap({bitmap:bmap});
//	});
//});
